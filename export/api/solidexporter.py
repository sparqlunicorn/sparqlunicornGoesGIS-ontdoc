...
class SolidExporter:
    ...
    def createSolidSettings(graph,outpath,deploypath,publisher,datasetname,classtree):
        ...
        typeindexgraph.add((URIRef(deploypath + "/settings/publicTypeIndex.ttl"), URIRef("http://www.w3.org/2000/01/rdf-schema#comment"), Literal("Public Type Index",lang="en")))
        ...
        typeindexgraph2.add((URIRef(deploypath + "/settings/privateTypeIndex.ttl"), URIRef("http://www.w3.org/2000/01/rdf-schema#comment"), Literal("Public Type Index",lang="en")))
