    ...
    def generateOGCAPIFeaturesPages(self,outpath,featurecollectionspaths,prefixnamespace,ogcapi,mergeJSON):
        ...
        for coll in featurecollectionspaths:
            ...
            if ogcapi:
                ...
                apijson["paths"]["/collections/"+str(self.shortenURI(opweb.replace(".geojson","")))]={"get":{"tags":["Collections"],"summary": "describes collection {collectionId}","description": "Describes the collection with the id {collectionId}","operationId": "collection-"+str(self.shortenURI(opweb.replace(".geojson",""))),"parameters":[],"responses": {"default": {"description": "default response","content": {"application/json": {"schema": {"$ref": "#/components/schemas/Collections"},"example": None}}}}}}
