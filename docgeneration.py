        ...
        if self.createIndexPages:
            for path in paths:
                ...
                if startconcept!=None and path==outpath and startconcept in uritotreeitem:
                    if self.createColl:
                        indexhtml+="<p>Start exploring the graph here: <img src=\""+tree["types"][uritotreeitem[startconcept][-1]["type"]]["icon"]+"\" height=\"25\" width=\"25\" alt=\""+uritotreeitem[startconcept][-1]["type"]+"\"/><a href=\""+str(startconcept).replace(prefixnamespace,outpath)+"\">"+self.shortenURI(startconcept)+"</a></p>"                    
                    else:
                        indexhtml+="<p>Start exploring the graph here: <img src=\""+tree["types"][uritotreeitem[startconcept][-1]["type"]]["icon"]+"\" height=\"25\" width=\"25\" alt=\""+uritotreeitem[startconcept][-1]["type"]+"\"/><a href=\""+str(startconcept).replace(prefixnamespace,outpath)+"\">"+self.shortenURI(startconcept)+"</a></p>"
