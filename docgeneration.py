                ...
                if os.path.exists(coll):
                    ...
                    for feat in curcoll["features"]:
                        ...
                        try:
                            ...
                            print("CHECKPATH: "+str(str(featpath.replace(prefixnamespace,outpath)+"/index.json").replace("//","/")))
                            if os.path.exists(featpath.replace(prefixnamespace,outpath)+"/index.json"):
                                ...
                                p.symlink_to(targetpath)
                            if os.path.exists(featpath.replace(prefixnamespace,outpath)+"/index.ttl"):
                                ...
                                p.symlink_to(targetpath)
                            if os.path.exists(featpath.replace(prefixnamespace,outpath)+"/index.html"):
