...
class DocConfig:
    ...
    metadatanamespaces=["http://ldf.fi/void-ext#","http://rdfs.org/ns/void#","http://purl.org/dc/terms/","http://purl.org/dc/elements/1.1/","http://www.w3.org/ns/prov#","http://www.w3.org/ns/prov-o/","http://creativecommons.org/ns#","http://www.w3.org/ns/dcat#","http://purl.org/cerif/frapo/","http://www.lido-schema.org/"]
    ...
    classtreequery="""PREFIX owl: <http://www.w3.org/2002/07/owl#>\n
            ...
            WHERE {\n
               { ?individual %%typeproperty%% ?subject . } UNION { ?subject %%typeproperty%% owl:Class . } UNION { ?subject %%typeproperty%% rdfs:Class . } UNION { ?individual %%subclassproperty%% ?subject } .\n
