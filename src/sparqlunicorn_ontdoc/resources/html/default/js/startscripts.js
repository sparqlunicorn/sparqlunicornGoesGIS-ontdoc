...
function determineTableCellLogo(uri){
    ...
    if(uri in labelproperties){
        result+="<img onclick=\"getClassRelationDialog(uri)\"  src=\""+iconprefix+"labelproperty.png\" height=\"25\" width=\"25\" alt=\"Label Property\"/>"
    ...
    if(!finished){
        for(ns in annotationnamespaces){
            if(uri.includes(annotationnamespaces[ns])){
                result+="<img onclick=\"getClassRelationDialog(uri)\" src=\""+iconprefix+"annotationproperty.png\" height=\"25\" width=\"25\" alt=\"Annotation Property\"/>"
    ...
    if(!finished && uri in geoproperties && geoproperties[uri]=="ObjectProperty"){
        result+="<img onclick=\"getClassRelationDialog(uri)\" src=\""+iconprefix+"geoobjectproperty.png\" height=\"25\" width=\"25\" alt=\"Geo Object Property\"/>"
        logourl=iconprefix+"geoobjectproperty.png"
    }else if(!finished && uri in geoproperties && geoproperties[uri]=="DatatypeProperty"){
        result+="<img onclick=\"getClassRelationDialog(uri)\" src=\""+iconprefix+"geodatatypeproperty.png\" height=\"25\" width=\"25\" alt=\"Geo Datatype Property\"/>"
        logourl=iconprefix+"geodatatypeproperty.png"
    }else if(!finished){
        result+="<img onclick=\"getClassRelationDialog(uri)\" src=\""+iconprefix+"objectproperty.png\" height=\"25\" width=\"25\" alt=\"Object Property\"/>"
...
function formatHTMLTableForClassRelations(result,nodeicon,nodelabel,nodeid){
    ...
    for(res in result["from"]){
        for(instance in result["from"][res]){
            ...
            dialogcontent+="<tr><td><img onclick=\"getClassRelationDialog(instance)\" src=\""+iconprefix+"class.png\" height=\"25\" width=\"25\" alt=\"Class\"/><a href=\""+instance+"\" target=\"_blank\">"+shortenURI(instance)+"</a></td>"
            dialogcontent+=determineTableCellLogo(res)[0]
            dialogcontent+="<td><img onclick=\"getClassRelationDialog(nodeid)\"  src=\""+nodeicon+"\" height=\"25\" width=\"25\" alt=\"Instance\"/><a href=\""+nodeid+"\" target=\"_blank\">"+nodelabel+"</a></td><td></td><td></td></tr>"
        }
    }
    for(res in result["to"]){
        for(instance in result["to"][res]){
            ...
            dialogcontent+="<tr><td></td><td></td><td><img onclick=\"getClassRelationDialog(nodeid)\" src=\""+nodeicon+"\" height=\"25\" width=\"25\" alt=\"Instance\"/><a href=\""+nodeid+"\" target=\"_blank\">"+nodelabel+"</a></td>"
            dialogcontent+=determineTableCellLogo(res)[0]
            dialogcontent+="<td><img onclick=\"getClassRelationDialog(instance)\"  src=\""+iconprefix+"class.png\" height=\"25\" width=\"25\" alt=\"Class\"/><a href=\""+instance+"\" target=\"_blank\">"+shortenURI(instance)+"</a></td></tr>"
        }
    }
    dialogcontent+="</tbody></table>"
    dialogcontent+="<button style=\"float:right\" id=\"closebutton\" onclick='document.getElementById(\"classrelationdialog\").close()'>Close</button>"
