...
class Model3DPage:
    ...
    @staticmethod
    def generatePageWidget(graph,foundmedia,annobodies,templates,subject,iiifmanifestpaths,image3dannos,pubconfig,imagetoURI,foundlabel,comment,thetypes,predobjmap,f,onlybody=False):
        print("PageWidget")
