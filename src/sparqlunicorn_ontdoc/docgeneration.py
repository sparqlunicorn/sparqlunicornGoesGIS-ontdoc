...
class OntDocGeneration:
    ...
    def generateOntDocForNameSpace(self, prefixnamespace,dataformat="HTML"):
        ...
        voidgraph=VoidExporter.createVoidDataset(self.datasettitle,prefixnamespace,self.deploypath,self.outpath,self.licenseuri,self.modtime,self.labellang,voidstats,set(),tree,predmap,nonnscount,instancecount,self.startconcept)
